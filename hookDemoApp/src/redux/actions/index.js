...
export const LoginAction = (email, password, users) => async (dispatch) => {
...
export const ForgotPasswordAction = (email, users) => async (dispatch) => {
  dispatch(isLoading(true));
...
export const ResetPasswordAction = (password, userId) => async (dispatch) => {
  dispatch(isLoading(true));
